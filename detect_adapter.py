...
def detect_most_likely_adapter(fname):
    ...
    if VERBOSE:
#        print("AUTO-DETECTING ADAPTER TYPE\n===========================")
#        print("Auto-detect adapter from first 10^6 sequences ( {} )".format(
#            fname)
#        )
...
#        print("Adapter type\tCount\tSequence\tSequences analysed\tPercentage")
    ...
    if best_adapter:
        return adapters[best_adapter].decode(),fname
    else:
        return "",""
